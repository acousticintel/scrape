...
export default function Users({ u }) {
    return (
        <div className="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4 mx-auto">
            <img className="w-full h-32 object-cover object-center" src={u.profileBannerUrl} alt="avatar" />
            <div className="flex items-center px-6 py-3 bg-gray-900">
                <GoVerified size='1.5em' className='text-blue-300 mr-3 w-auto' />
                <h1 className="mx-3 text-white font-semibold text-lg">{u?.verified ? 'Verified' : 'Not Verified'}</h1>
            </div>
            <div className="py-4 px-6">
                ...
                <p className="py-2 text-md text-gray-700">{u?.description}</p>
